...
t0 = t()
#output_downscale = downscale.downscale_helbig(mnt, idx_x=None, idx_y=None, type="map", librairie="numpy")
t1 = t()
print(t1-t0)
#downscale.downscale_helbig(mnt_small, idx_x=np.array([250, 489, 500, 800]), idx_y=np.array([827, 368, 983, 100]), type="indexes", plot=False)
